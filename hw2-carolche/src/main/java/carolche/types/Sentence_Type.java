...
public class Sentence_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("carolche.types.Sentence");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "carolche.types.Sentence");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "carolche.types.Sentence");
