 ...
 * @generated */
public class Annotation_nemine extends Annotation {
  /**
   * @generated
   * @ordered
   */
  @SuppressWarnings("hiding")
  public final static int typeIndexID = JCasRegistry.register(Annotation_nemine.class);
   ...
   * @generated
   */
  protected Annotation_nemine() {/* intentionally empty block */}
   ...
   */
  public Annotation_nemine(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Annotation_nemine(JCas jcas) {
    super(jcas);
    readObject();   
  } 
   ...
   */
  public Annotation_nemine(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
