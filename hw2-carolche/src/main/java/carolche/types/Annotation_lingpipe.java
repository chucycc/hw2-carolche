 ...
 * @generated */
public class Annotation_lingpipe extends Annotation {
  /**
   * @generated
   * @ordered
   */
  @SuppressWarnings("hiding")
  public final static int typeIndexID = JCasRegistry.register(Annotation_lingpipe.class);
   ...
   * @generated
   */
  protected Annotation_lingpipe() {/* intentionally empty block */}
   ...
   */
  public Annotation_lingpipe(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Annotation_lingpipe(JCas jcas) {
    super(jcas);
    readObject();   
  } 
   ...
   */
  public Annotation_lingpipe(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
