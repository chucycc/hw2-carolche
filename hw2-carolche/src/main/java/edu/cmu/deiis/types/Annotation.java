...
public class Annotation extends org.apache.uima.jcas.tcas.Annotation {
  ...
  /**
   * getter for geneName - gets The identified gene names from the input sentences.
   * 
   * @generated
   * @return value of the feature
   */
  public String getGeneName() {
    if (Annotation_Type.featOkTst && ((Annotation_Type)jcasType).casFeat_geneName == null)
      jcasType.jcas.throwFeatMissing("geneName", "edu.cmu.deiis.types.Annotation");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Annotation_Type)jcasType).casFeatCode_geneName);}
    
  /**
   * setter for geneName - sets The identified gene names from the input sentences.
   * 
   * @generated
   * @param v
   *          value to set into the feature
  ...
  public void setGeneName(String v) {
    if (Annotation_Type.featOkTst && ((Annotation_Type)jcasType).casFeat_geneName == null)
      jcasType.jcas.throwFeatMissing("geneName", "edu.cmu.deiis.types.Annotation");
    jcasType.ll_cas.ll_setStringValue(addr, ((Annotation_Type)jcasType).casFeatCode_geneName, v);}    
  }
